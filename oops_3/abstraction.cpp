...
class customer{                  // this whole class can be present in some other file,in which the implementataion details
                                //  of the function are implemented,and are hidden to the other module which is using this file,great
...
public:
    ...
    { //  this is abstracion,in which detailes are not shown to the user,and only the functionality he can use
        if (age > 0 && age < 100)
        {
            this->age = age;
        }
...
}; // this whole class can be present in some other file,in which the implementataion details
//  of the function are implemented,and are hidden to the other module which is using this file,great
